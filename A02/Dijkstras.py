...
class Graph:
    ...
    def add_edge(self, name, neighbor, ospf):
        self.vertices[name][neighbor] = ospf
    ...
    def shortest_path_pair(self):
        pairs = defaultdict(dict)
        for start_vertex in self.vertices:
            for destination_vertex in self.vertices:
                pairs[start_vertex, destination_vertex] = self.shortest_path(start_vertex, destination_vertex)
        return pairs
